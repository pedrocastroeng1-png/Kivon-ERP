  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-kivon-card border border-kivon-border shadow-xl p-6">
        <div className="mb-6 flex items-center rounded-lg border border-kivon-border bg-kivon-bg px-3 focus-within:ring-1 focus-within:ring-kivon-primary focus-within:border-kivon-primary transition-all h-12 sm:h-10">
